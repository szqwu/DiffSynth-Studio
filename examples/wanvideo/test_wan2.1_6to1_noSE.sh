...
# Script to run Wan2.1 6-to-1 no-SE (no Separated Encoding) NVS evaluation on DL3DV-10K scenes

# ── Configuration ──────────────────────────────────────────────────────────────
checkpoint_path="./models/train/Wan2.1-noSE-14B-lora32-6to1_1000_3/step-2000.safetensors"
output_path="/data2/qiwu2/dl3dv_test_results_wan21_6to1_noSE"
GPU_ID=5
...
echo "========================================"
echo "Wan2.1 6-to-1 no-SE NVS - DL3DV-10K Evaluation"
echo "========================================"
...
CUDA_VISIBLE_DEVICES=$GPU_ID python test_wan2.1_6to1_noSE.py \
