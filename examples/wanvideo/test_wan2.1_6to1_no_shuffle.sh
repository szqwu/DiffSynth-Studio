...
# No-pixel-unshuffle variant (bilinear downsampling for raymaps, new_in_dim=42)

# ── Configuration ──────────────────────────────────────────────────────────────
checkpoint_path="./models/train/Wan2.1-SE-14B-lora32-6to1-no-shuffle/epoch-79.safetensors"
output_path="/data2/qiwu2/dl3dv_test_results_wan21_6to1_no-shuffle_epoch-79"
GPU_ID=0
...
echo "========================================"
echo "Wan2.1 6-to-1 NVS - No Pixel Unshuffle"
echo "========================================"
