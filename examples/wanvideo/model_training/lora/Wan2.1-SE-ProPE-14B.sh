accelerate launch --config_file my_config.yaml model_training/train_SE.py \
  ...
  --output_path "./models/train/Wan2.1-SE-14B-lora32-6to1_prope" \
  --lora_base_model "dit" \
  ...
  --wandb_run_name "lora32-6to1-prope" \
  --resume_checkpoint "./models/train/Wan2.1-SE-14B-lora32-6to1_prope/epoch-last-79.safetensors"
