...
accelerate launch --config_file my_config.yaml model_training/train_SE.py \
  ...
  --output_path "./models/train/Wan2.1-SE-14B-lora32-zero-temporal-rope" \
  --lora_base_model "dit" \
  ...
  --wandb_run_name "lora32-zero-temporal-rope" \
  --num_input_frames 6 \
  # --resume_checkpoint "./models/train/Wan2.1-SE-14B-lora32-zero-temporal-rope_3/epoch-last.safetensors" \
