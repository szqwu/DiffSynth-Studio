accelerate launch --config_file my_config.yaml model_training/train_SE.py \
  ...
  --output_path "./models/train/Wan2.1-SE-CameraAdapter-14B-lora32-6to1-resume" \
  --lora_base_model "dit" \
  ...
  --wandb_run_name "camera-adapter-lora32-6to1-resume" \
  --resume_checkpoint "./models/train/Wan2.1-SE-CameraAdapter-14B-lora32-6to1/epoch-last.safetensors"
